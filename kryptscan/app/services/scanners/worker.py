...
class WorkerScannerProvider:
    ...
    def schedule(self, target: str, asset_type: str, *, assessment_mode: str = "vulnerability_assessment", scan_tier: str = "full_scan", scan_protocols: list[str] | None = None) -> ScheduledScan:
